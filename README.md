...
- Schéma détaillé : [`documentation_schema.md`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/documentation_schema.md)
- Diagnostic qualité Bronze : [`rapport_diagnostic_bronze.docx`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/rapport_diagnostic_bronze.docx)
- Nettoyage Silver : [`rapport_nettoyage_silver.docx`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/rapport_nettoyage_silver.docx)
- Agrégations et validation Gold : [`rapport_gold.docx`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/rapport_gold.docx)
- **Synthèse complète du projet (pour toute l'équipe)** : [`synthese_complete_projet.docx`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/synthese_complete_projet.docx)
...
```
git clone https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique.git
```
...
├── Presentation_groupe7.pptx          # Support de soutenance (15 min)
...
La comparaison de plusieurs critères de détection d'anomalies contre les 992 attaques connues du dataset a montré que la **diversité des machines accédées par utilisateur** est le signal le plus efficace (90,73 % de détection), loin devant le critère horaire seul (4,23 %). Combinés, les critères détectent 91,63 % des attaques connues. Détail complet dans [`rapport_gold.docx`](https://github.com/Julius-CREPPY/groupe7-lakehouse-forensique/blob/main/rapport_gold.docx).
